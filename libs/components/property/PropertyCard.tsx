...
const PropertyCard = (props: PropertyCardType) => {
	...
	if (device === 'mobile') {
		return (
			<Stack className="card-config">
				<Typography>PROPERTY CARD</Typography>
			</Stack>
		);
	} else {
		return (
			<Stack className="card-config">
				<Stack className="top">
					...
					{property && property?.propertyRank > topPropertyRank && renderTopBadge()}
					<Box component={'div'} className={'price-box'}>
						<Typography>${formatterStr(property?.propertyPrice)}</Typography>
					</Box>
				</Stack>
				...
				<Stack className="bottom">
					...
					{/* Options Section */}
					<Stack className="options">{renderPropertyType()}</Stack>
